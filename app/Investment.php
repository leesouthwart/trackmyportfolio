...
class Investment extends Model
{
    ...
    public function editInvestment($oldData, $args)
    {
        ...
        $currentInvestmentAmount = $investment->amount_of_asset;
        $oldTransactionAmount = $oldData->amount_of_asset;
        $newTransactionAmount = $args['amount_of_asset'];
        ...
        $investment->update($new_args);
        $investment->save($new_args);
    }
}
